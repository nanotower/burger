...
const withErrorHandler = (WrappedComponent, axios) => {
  return class extends Component {
    ...
    componentWillUnmount() {
      ...
      axios.interceptors.request.eject(this.InterceptorRes);
    ...
    render() {
      return (
        <Aux>
          <Modal show={this.state.error} modalClosed={this.closeErrorHandler}>{this.state.error? this.state.error.message : null}</Modal>
